...
export default {
  ...
  data(){
      return {
          ...
          link:'/home/statistical/statisticalThree/statistical_yy',
          page:1,
          count:10,
          total:0,
          list:{
  ...
  methods:{
      ...
      get_list(){
            ...
            function callback(msg){
                ...
                for(let i=0;i<a.length;i++){
                    THIS.list.list.push([
                        { class:'v_color01',title:a[i].name,flag:false  },
   ...
   mounted(){
      ...
      this.store.commit('setPageText','当前位置：统计 / 运营中心统计详情');
      this.get_list();

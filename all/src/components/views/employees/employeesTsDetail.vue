                          ...
                          <div class="flex_1 flex col">
                              <div class="flex_1 flex row">
                                  <div class="flex_1 flex col pad_l_50 pl">
                                      ...
                                      <div class="flex_1 font14"><span class="span_color">投诉驻厂：</span>{{msg.zhuchangname}}</div>
                                      <div class="flex_1 font14"><span class="span_color">投诉内容：</span>{{msg.content}}</div>
                                  </div>
                              </div>
                          </div>
                          <div class="flex_1 flex col">
                              <div class="flex_1 flex col pad_l_50 pl">
                                  ...
                                  <div class="flex_1 font14"><span class="span_color">所在企业：</span>{{msg.companyname}}</div>
                                  <div class="flex_1 font14"><span class="span_color">投诉时间：</span>{{msg.createat}}</div>
                                  <div class="flex_1 font14"></div>
                              </div>
                          </div>
                          <div class="flex col" style="width:180px;">
                              <div class="top h_40px flex row j_between">
                                  <span v-show="permissions['suggestion.reply']==1" class="d_block base_btn base_btn_co01 font14 pointer" @click="send_btn()">回复Ta</span>
                                  <span v-show="permissions['suggestion.delete']==1" class="d_block base_btn base_btn_co02 font14 pointer" @click="deletes(msg.id)">删除投诉</span>
                              </div>
                          </div>
                      </div>
...
export default {
  ...
  data(){
      return {
          id:'',
          permissions:'',
          link:'/home/employees/employeesThree/employeesTs',
          msg:{},
          replys:[],
          isBack:true,
          //弹窗回复
  ...
  methods:{
      ...
      deleteFunc(){
            ...
            vue_Post(THIS,'suggestion/delete',data,callback,1,1,1,0);
            function callback(msg){
                THIS.$message({
                    type: 'success',
                    message: '删除成功!',

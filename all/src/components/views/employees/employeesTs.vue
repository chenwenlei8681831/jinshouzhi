          ...
          <div class="views pad_l_50 pad_r_50 b_s mr_color01 h_bottom">
                <div class="bg_fff">
                    ...
                    <div class="views_100ch_1">
                        <!--顶部数据-->
                        <div class="pad_l_30 pad_r_30 w_100 header_item h_60px b_s font14">员工投诉列表（{{total}}）</div>
                        <!--输入框、下拉筛选-->
                        ...
                        <div class="list">
                            <ol class="list_header list_bg">
                                ...
                                <li class="h_50px pad_l_20 b_s f_l">投诉人</li>
                                <li class="h_50px pad_l_20 b_s f_l">联系电话</li>
                                <li class="h_50px pad_l_20 b_s f_l">所属企业</li>
                                <li class="h_50px pad_l_20 b_s f_l">投诉驻厂</li>
                                <li class="h_50px pad_l_20 b_s f_l">投诉时间</li>
                                ...
                                <li @click.stop="view(1,item.id)" v-for="(item,index) in list" :key="index">
                                    <ol :class="index%2==1?'list_bg':''">
                                        ...
                                        <li class="f_l pad_l_20 b_s" style="width:13%">
                                            <span v-show="permissions['suggestion.details']==1" class="edit_button w_50 f_l" @click.stop="view(1,item.id)">查看</span>
                                            <span v-show="permissions['suggestion.delete']==1" class="edit_button w_50 f_l list_co02" @click.stop="view(2,item.id)">删除</span>
                                        </li>
                                        <div class="clearfix"></div>
                                    </ol>
                                </li>
...
export default {
  ...
  methods:{
      ...
      getList(){
            ...
            vue_Post(THIS,'suggestion/list',data,callback,1,1,1,1);
            function callback(msg){
                  THIS.total = msg.total;
                  THIS.list = msg.list;
                  for(let i=0;i<THIS.list.length;i++){
                      THIS.list.createat = THIS.list.createat?THIS.list.createat.split(' ')[0]:'--';
                  };
            }; 
      },
      ...
      view(type,id){
          if(type==1&&THIS.permissions['suggestion.details']==1){
                THIS.$router.replace('/home/employees/employeesThree/employeesTsDetail/'+id);
          }else if(type==2){
                THIS.id = id;
   ...
   mounted(){
        THIS = this;
        THIS.store.commit('setPageText','当前位置：员工 / 员工投诉');

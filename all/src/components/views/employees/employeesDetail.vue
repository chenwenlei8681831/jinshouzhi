              ...
              <div class="bg_fff">
                  ...
                  <div class="views_100ch_1 pad_all_30">
                      ...
                      <div class="flex row b_line mar_t_30 baseInfo pad_b_20">
                          ...
                          <div class="flex_1 flex col" style="height:350px">
                                <div class="flex_1 flex col pad_l_20">
                                    <div class="flex_1 font14"><span class="span_color">真实姓名：</span>{{msg.name?msg.name:'--'}}</div>
                          ...
                          <div class="flex col" style="width:180px;height:270px">
                              <div class="top h_40px flex row j_end">
                                  <span class="d_block base_btn base_btn_co01 pointer" @click="edit(id,seleteIndex)">编辑</span>
                              </div>
                          </div>
                      </div>
                          ...
                          <div class="flex_1">
                                ...
                                <div class="flex row  b_line mar_t_30 pad_b_20">
                                    <div class="zp_box  mar_r_30" v-for="(item,index) in zpArr_right" :key="index">
                                        <!--<img  class="w_100" :src="item.val" alt="">-->
                                        <div v-if="item.val" class="w_100 demo-image__preview">
                                            <el-image 
                                                style="height: 60px;width:100%"
                                                :src="item.val" 
                          ...
                          <ul class="w_100">
                              <li class="w_100">
                                  <ol class="co03 row flex h_50px line_50px list_item" :class="index%2==1?'li_bg':''"  v-for="(item,index) in work_list" :key="index">
                                        ...
                                        <li class="font14 flex_2 pad_l_30 h_50px b_s s_l">{{item.lizhiat&&item.lizhiat!='0000-00-00'?item.lizhiat:'--'}}</li>
                      ...
                      <p v-show="work_list.length==0" class="font14 text_center list_co0" style="line-height:50px">暂无数据</p>
                      ...
                      <p class="font14 text_center list_co0" style="line-height:50px" v-if="false">暂无数据</p>
...
export default {
  ...
  methods:{
      ...
      edit(id,type){
          this.$router.replace('/home/employees/employeesOne/employeesEdit/'+id+'/'+type);
      },
   ...
   mounted(){
        ...
        THIS.seleteIndex = THIS.$route.params.type;
        THIS.get_detail();

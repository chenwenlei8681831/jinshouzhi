...
export default {
  ...
  data(){
      return {
          ...
          type:'',
          picture:'',
          link:'/home/affair/affairTwo/center_yglb',
          zpArr_left:[],
          srcList01:[],
          left:[],
          right:[],
            ...
            function callback(msg){
                ...
                if(THIS.type==1){//1待发送、2已发送、
                    ...
                    THIS.left = [
                        ...
                        { title:'身份证号码：',value:msg.idcard?msg.idcard:'--' },
                        { title:'备注信息：',value:msg.mark?msg.mark:'--' },
                        { title:'所属业务员：',value:msg.mark?msg.mark:'--' },
                        { title:'状态：', value:msg.status==1?'待接收':(msg.status==2?'待入职':'待定') }
                    ];
                    THIS.right = [
                        { title:'员工姓名：',value:msg.name?msg.name:'--' },
                        ...
                        { title:'户籍所在地：',value:msg.address?msg.address:'--' },
                        { title:'曾用名：',value:msg.former_name?msg.former_name:'--' },
                        { title:'运营中心：',value:msg.realtitle?msg.realtitle:'--' },
                        { title:'意向企业：',value:msg.yewuyuan_name?msg.yewuyuan_name:'--' },
                        { title:'录入时间：',value:msg.reach_time?msg.reach_time:'--' }
                    ];
                };
                //身份证照片

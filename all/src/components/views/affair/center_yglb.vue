                ...
                <div class="views_100ch_1">
                    ...
                    <div class="list">
                        <ol class="list_header flex row">
                            ...
                            <li class="h_50px pad_l_20 b_s" style="width:10%">姓名</li>
                            <li class="h_50px pad_l_20 b_s flex_1">联系电话</li>
                            <li class="h_50px pad_l_20 b_s flex_1">运营中心</li>
                            <li class="h_50px pad_l_20 b_s flex_1">{{seleteIndex==0?'意向企业':'入职企业'}}</li>
                            <li class="h_50px pad_l_20 b_s flex_1">{{seleteIndex==0?'录入时间':'发送时间'}}</li>
                        ...
                        <ul class="list_main">
                            <li @click.stop="view(item.id)" v-for="(item,index) in list" :key="index">
                                <ol :class="index%2==1?'list_bg':''" class="flex row">
                                    ...
                                    <li class="pad_l_20 b_s" style="width:10%" :title="item.name?item.name:'--'">{{item.name?item.name:'--'}}</li>
...
export default {
  ...
  data(){
      return {
          ...
          phone:'',
          seleteArr:[
              {name:'待发送员工',number:'0',type:0},
              {name:'已发送员工',number:'0',type:1}
          ],
          list:[],
  ...
  methods:{
      ...
      view(id){
          ...
          THIS.$router.replace('/home/affair/affairTwo/centerYglbDetail/'+id+'/'+type);
      },

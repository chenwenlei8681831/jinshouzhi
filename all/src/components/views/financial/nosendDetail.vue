                ...
                <div class="views_100ch_1">
                    ...
                    <div class="list">
                        <ol class="list_header">
                            ...
                            <li class="h_50px pad_l_20 b_s f_l">工资金额(元)</li>
                            <div class="clearfix"></div>
                        </ol>
                        <ul class="list_main">
                            <li class="" v-for="(item,index) in list" :key="index">
                                <ol :class="index%2==1?'list_bg':''">
                                    ...
                                    <li class="f_l pad_l_20 b_s" :title="item.shifa_price?item.shifa_price:'0'">{{item.shifa_price?item.shifa_price:'0'}}</li>
                                    <div class="clearfix"></div>
                                </ol>
                            </li>
                        </ul>
...
export default {
  ...
  data(){
      return {
          id:'',
          link:'/home/financial/nosendOne/nosendList',
          page:1,
          count:10,
          total:0,
          keyword:'',

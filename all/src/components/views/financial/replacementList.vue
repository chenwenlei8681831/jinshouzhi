                ...
                <div class="views_100ch_1">
                    ...
                    <div class="list">
                        <ol class="list_header">
                            ...
                            <li class="h_50px pad_l_20 b_s f_l">补发企业</li>
                            ...
                            <li class="" v-for="(item,index) in list" :key="index">
                                <ol :class="index%2==1?'list_bg':''">
                                    ...
                                    <li class="f_l pad_l_20 b_s" style="width:13%">
                                        <span class="edit_button w_50 f_l" @click="view(1,item.jiesuan_id)">查看</span>
                                        <span v-if="seleteIndex==0" class="edit_button w_50 f_l" @click="view(2,item.id)">下载</span>
                                    </li>
                                    <div class="clearfix"></div>
                                </ol>
                            </li>
...
export default {
  ...
  data(){
      return {
            ...
            company:'',
            seleteArr:[
                {name:'待补发',number:'0',type:0},
                {name:'已补发',number:'0',type:1}
            ],
            list:[],
      }
  },
  methods:{
        ...
        getList(){
                ...
                function callback(msg){
                    ...
                    THIS.seleteArr[0].number = msg.total_daifa?msg.total_daifa:0;
                    THIS.seleteArr[1].number = msg.total_bufa?msg.total_bufa:0;
                }; 
        },

        view(type,id){
            if(type==1){
                THIS.$router.replace('/home/financial/replacementOne/replacementDetail/'+id+'/'+THIS.seleteIndex);
            }else if(type==2){
                THIS.$confirm('确定下载吗?', '提示', {
                    ...
                    var bb = window.localStorage.host+'jiesuan/daifaExport?token='

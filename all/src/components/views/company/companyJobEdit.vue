<template>
            ...
            <div class="views h_bottom po_r pad_l_50 pad_r_50 b_s mr_color01">
                    ...
                    <!--表单-->
                    <el-form :model="ruleForm"  :rules="rules" ref="ruleForm" class="views_100ch_2 demo-ruleForm">
                        <div class="from_box">
                            ...
                            <div class="w_100 b_s pad_l_30 pad_r_30 mar_t_30">
                                ...
                                <el-form-item class="w_30" label="选择企业" prop="company">
                                    <el-select class="w_100 d_b_line" v-model="ruleForm.company" clearable filterable  remote :remote-method='search_company' placeholder="请选择企业">
                            ...
                            <div class="w_100 b_s pad_l_30 pad_r_30 mar_t_30">
                                <div class="flex row j_between">
                                    ...
                                    <el-form-item class="w_30" label="招聘人数(人)" prop="number" >
                                        <el-input v-model="ruleForm.number" placeholder="请输入招聘人数"></el-input>
                                    </el-form-item>
                                </div>
                                <div class="flex row j_between">
                                    ...
                                    <div class="w_65">
                                        <p class="font14" style="line-height:32px;"><span style="color:#F35149;">*</span>招聘期限</p>
                                        <el-date-picker
                                            class="w_60"
                            ...
                            <div class="w_100 b_s pad_l_30 pad_r_30 mar_t_30">
                                <div class="flex row j_between">
                                    ...
                                    <el-form-item class="w_30" :label="ruleForm.jxfs==1?'员工单价(元/小时)':'同工同酬工资(元/月)'" prop="ygdj" >
                                        <el-input v-model="ruleForm.ygdj" placeholder="请输入员工单价" clearable></el-input>
                                    </el-form-item>
                                    <div class="w_30 row flex">
                                        <el-form-item class="w_40 mar_r_10" label="薪资范围(最低)" prop="xzfw_down" >
                                            <el-input v-model="ruleForm.xzfw_down" clearable placeholder="请输入薪资范围最低"></el-input>
                                        </el-form-item>    
                                        <div class="b_s" style="padding-top:30px;line-height:32px;"> ~ </div>
                                        <el-form-item class="w_40 mar_l_10" label="薪资范围(最高)" prop="xzfw_top" >
                                            <el-input v-model="ruleForm.xzfw_top" clearable placeholder="请输入薪资范围最高"></el-input>
                                        </el-form-item>
                                    </div>
                                </div>
                                <div class="flex row j_between">
                                ...
                                <div class="w_100 flex row j_between mar_t_30">
                                    <el-form-item class="from_textarea_120px w_45"  label="运营中心绩效" prop="jx_mark">
                                        <el-input  type="textarea" v-model="ruleForm.jx_mark" placeholder="请输入运营中心绩效"></el-input>
                                    </el-form-item>
                                    <el-form-item class="from_textarea_120px w_45"  label="其他说明（选填）">
                                        <el-input  type="textarea" v-model="ruleForm.jx_shuoming" placeholder="请输入其他说明"></el-input>
                                    </el-form-item>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="from_box mar_t_30">
                            ...
                            <div v-if="ruleForm.jsfs==1" class="b_s pad_l_20 pad_r_20">
                                <div class="b_s" style="padding:0.1rem 0.3rem 0;">
                                    <el-form-item class="from_textarea_120px flex_1" prop="cwjsbz_xt"  label="系统结算备注:">
                                        <el-input  type="textarea" v-model="ruleForm.cwjsbz_xt" placeholder="请输入系统结算备注"></el-input>
                                    </el-form-item>   
                                </div>
                                <!--开票信息-->
...
export default {
  ...
  methods:{
        ...
        get_detail(){
                ...
                vue_Post(THIS,'company/details',data,callback,1,0,0,1);
                function callback(msg){
                    ...
                    if(THIS.id){
                        ...
                        THIS.img_value = [];
                        var imgArr = [];
                        for(let i=0;i<msg.info.picture.length;i++){
                            imgArr[i] = msg.info.picture[i].path_name;
                            THIS.img_value.push({url:msg.info.picture[i].path_name,name:''});
                        };
                        var yy = msg.info.welfare_tag;
                        yy = yy?yy:[];
                        for(let i=0;i<THIS.company_tag_info.length;i++){
                            for(let j=0;j<yy.length;j++){
                                if(yy[j].id==THIS.company_tag_info[i].id){
                                    THIS.company_tag_info[i].flag = true;
                                };
                            };
                        };
                        THIS.companyArr = [{realtitle:msg.info.realtitle,id:parseInt(THIS.id)}];
                        var jiesuan_mark = '';
                        if(info.hesuanfangshi==1){
                            jiesuan_mark = info.jiesuan_mark;
                        };
                        var sh_msg = [];
                        var xs_msg = [];
                        var tg_sh_msg = {
                        ...
                        if((info.hesuanfangshi==0)&&(info.jxfs==1)){
                            //社会工
                            var shehui_job = info.shehui_job;
                            for(let i=0;i<shehui_job.length;i++){
                                var bumen = [];
                                var ss = shehui_job[i].bumen;
                                for(let j=0;j<ss.length;j++){
                                    var condition = [];
                                    ss[j].condition = (ss[j].condition&&ss[j].condition.length>0)?ss[j].condition:[{"system_price":"","system_yuangong_price":"","system_jixiao":"","effect_time":""}];
                                    for(let k=0;k<ss[j].condition.length;k++){
                                        if((ss[j].condition[k].number)&&(ss[j].condition[k].number.length>0)){
                                            //有人数条件
                                            var number = [];
                                            var a_ss = ss[j].condition[k].number;
                                            for(let m=0;m<a_ss.length;m++){
                                                number.push({
                                                    rs_start:a_ss[m].min?a_ss[m].min:0,
                                                    rs_end:a_ss[m].max?a_ss[m].max:0,
                                                    jx:a_ss[m].system_jixiao
                                                });
                                            };
                                            condition.push({
                                                timer:ss[j].condition[k].effect_time?ss[j].condition[k].effect_time:'',
                                                qy_price:ss[j].condition[k].system_price,
                                                yg_price:ss[j].condition[k].system_yuangong_price,
                                                rs_msg:number
                                            });
                                        }else{
                                            //无人数条件
                                            condition.push({
                                                ...
                                                qy_price:ss[j].condition[k].system_price,
                                                yg_price:ss[j].condition[k].system_yuangong_price,
                                                jx_price:ss[j].condition[k].system_jixiao,
                                                rs_msg:[]
                                            });
                                        };
                                    };
                                    bumen.push({ tj_msg: condition});
                                };
                                sh_msg.push({
                                    timer:[shehui_job[i].startdate,shehui_job[i].enddate],
                                    shouqi_flag:false,
                                    bm_msg:bumen
                                });
                            };
                            //学生工
                            var xuesheng_job = info.xuesheng_job;
                            for(let i=0;i<xuesheng_job.length;i++){
                                console.log(123,xuesheng_job);
                                var bumen = [];
                                var ss = xuesheng_job[i].bumen;
                                for(let j=0;j<ss.length;j++){
                                    var condition = [];
                                    ss[j].condition = (ss[j].condition&&ss[j].condition.length>0)?ss[j].condition:[{"system_price":"","system_yuangong_price":"","system_jixiao":"","effect_time":""}];
                                    for(let k=0;k<ss[j].condition.length;k++){
                                ...
                                xs_msg.push({
                                    timer : [xuesheng_job[i].startdate,xuesheng_job[i].enddate],
                                    shouqi_flag : false,
                                    bm_msg : bumen
                                });
                            };
                        };
                        if((info.hesuanfangshi==0)&&(info.jxfs==2)){
                            var shehui_obj = info.yue_job.shehui?info.yue_job.shehui:null;
                            var xuesheng_obj = info.yue_job.xuesheng?info.yue_job.xuesheng:null;
                            if(shehui_obj){
                                tg_sh_msg = {
                                    tg_jsfs:(shehui_obj.js_type==1)?0:(shehui_obj.js_type==3?1:2),        //0:按小时   1：按全天   2：按百分比
                                    tg_laowufee:shehui_obj.laowu_price,
                                    tg_jx:shehui_obj.system_jixiao,
                                    tg_yewufee:shehui_obj.manage_fee,
                                    tg_qybd:shehui_obj.gz_type==1?shehui_obj.company_baoli:'',
                                    tg_gsbd:shehui_obj.gz_type==1?shehui_obj.jsz_baoli:'',
                                    tg_fffs:parseInt(shehui_obj.gz_type),               //0:企业全额  1:补差额
                                    tg_yflx:parseInt(shehui_obj.month_type),            //0:自然月  1:固定月
                                    tg_qqts:shehui_obj.month_type==1?shehui_obj.month_day:'',         //全勤天数
                                    tg_ygdj:shehui_obj.gz_type!=1?shehui_obj.jsz_baoli:'',            //员工单价(公司发放情况下)
                                };
                            }else{
                                tg_sh_msg = {
                                    tg_jsfs:0,                                      
                            ...
                            if(xuesheng_obj){
                                tg_xs_msg = {
                                    tg_jsfs:(xuesheng_obj.js_type==1)?0:(xuesheng_obj.js_type==3?1:2),    //0:按小时   1：按全天   2：按百分比
                                    tg_laowufee:xuesheng_obj.laowu_price,
                                    tg_jx:xuesheng_obj.system_jixiao,
                                    tg_yewufee:xuesheng_obj.manage_fee,
                                    tg_qybd:xuesheng_obj.gz_type==1?xuesheng_obj.company_baoli:'',
                                    tg_gsbd:xuesheng_obj.jsz_baoli,
                                    tg_fffs:parseInt(xuesheng_obj.gz_type),              //0:企业全额  1:补差额
                                    tg_yflx:parseInt(xuesheng_obj.month_type),           //0:自然月  1:固定月
                                    tg_qqts:xuesheng_obj.month_type==1?xuesheng_obj.month_day:'',      //全勤天数
                                    tg_ygdj:xuesheng_obj.gz_type!=1?xuesheng_obj.jsz_baoli:'',     //员工单价(公司发放情况下)
                                };
                            }else{
                                 tg_xs_msg = {
                                    tg_jsfs:0,                                      
                        ...
                        THIS.ruleForm = {
                            company:parseInt(info.id),
                            dw_name:info.title,
                            product:info.product,
                            address:[info.province,info.city,info.area],
                            xx_address:info.address,
                            up_sp:'',
                            isTop:info.top,
                            job:parseInt(info.gangwei),
                            xingzhi:parseInt(info.xingzhi),
                            number:info.number,
                            imgArr:imgArr,
                            wenan:info.wenan,
                            age:info.age,
                            timer:[info.zhaopinqixian,info.zhaopinqixian_end],
                            cailiao:info.zhengjian,
                            shuoming:info.zhaopin_other,
                            ygdj:info.yggz,
                            tijian:info.tijian,
                            xzfw_down:info.xzfwdown,
                            xzfw_top:info.xzfwup,
                            fxyh:parseInt(info.default_bankname),
                            fxsj:parseInt(info.gzjs),
                            js_start:info.start_date,
                            js_end:info.end_date,
                            jx_mark:info.jx,
                            jx_shuoming:info.xinzi_other,
                            hsqk:info.jctj,
                            zsqk:info.zstj,
                            sbfl:info.djbx,
                            cfbx:info.cfbx,
                            shfyz:info.shfyz,
                            sssm:info.other,
                            cwjsbz:info.jiesuan_mark,
                            jxfs:parseInt(info.jxfs),                       //计薪方式
                            jsfs:parseInt(info.hesuanfangshi)==1?0:1,       //核算方式
                            cwjsbz_xt:parseInt(info.hesuanfangshi)==0?info.jiesuan_mark2:'',
                            djr:info.qiye_duijie,
                            djrdh:info.qiye_duijie_phone,
                            //绩效内容：
                            jx_type:1,                                          //绩效类型：1 社会工  2 学生工
                            js_kaipiao_company:'江西金手指劳务派遣有限公司',
                            js_kaipiao_info:'纳税人识别号：913601085736184223 地址、电话：江西省南昌市南昌经济技术开发区桂苑大道创业',
                            //小时工
                            yewu_fee:info.manage_fee,
                            sh_msg:sh_msg,
                            xs_msg:xs_msg,
                            //同工同酬
                            tg_sh_msg:tg_sh_msg,
        ...
        submit_from(){
                ...
                var data = {
                    ...
                    //人工核算 
                    jiesuan_mark:THIS.ruleForm.cwjsbz,
                    //系统核算
                    ...
                    shehui_job:shehui_job.length>0?JSON.stringify(shehui_job):'',
                    xuesheng_job:xuesheng_job.length>0?JSON.stringify(xuesheng_job):'',
        ...
        remove_rs(index,v_index,s_index,rs_msg){
            if(THIS.ruleForm.jx_type==1){
                THIS.ruleForm.sh_msg[index].bm_msg[v_index].tj_msg[s_index].rs_msg.splice(rs_msg,1);
            }else if(THIS.ruleForm.jx_type==2){
                THIS.ruleForm.xs_msg[index].bm_msg[v_index].tj_msg[s_index].rs_msg.splice(rs_msg,1);
            };
        },
  ...
  mounted(){
      ...
      THIS = this;
      THIS.store.commit('setPageText','当前位置：企业 / 编辑岗位');

                ...
                <el-form :model="ruleForm" label-position='left' :rules="rules" ref="ruleForm" class="views_100ch_2 demo-ruleForm">
                    <div class="from_box flex j_center">
                        <div class="b_s pad_l_30 pad_r_30 mar_t_30" style="width:780px;">
                            ...
                            <div v-show="permissions['msg.sendnoteconfig']==1" class="flex row mar_t_30">
...
export default {
  ...
  data(){
      return {
          ...
          editorOption:{
                modules:{
                    toolbar:[
                        ['bold','italic','strike','underline',{ 'color': [] }]
                    ]
                }
          },
          content:''
  ...
  methods:{
      ...
      submit_from(){
            ...
            function callback(msg){
                ...
                if(THIS.ruleForm.company){
                    THIS.$router.replace('/home/message/messageThree/zgMessage');
                }else{
      ...
      get_msg(){
            if(THIS.permissions['msg.sendnoteconfig']!=1){
                return false;
            };
            var data = sign({});
            vue_Post(THIS,'msg/sendNoteConfig',data,callback,0,0,0,0);
            function callback(msg){
                THIS.cities = [];
                THIS.citiesKey = [];
